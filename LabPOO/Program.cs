...
namespace LabPOO
{
    ...
    class Program
    {
        ...
        public static List<Product> ingredientesreceta;
        ...
        public static void Ingredientesreceta()
        {
            ingredientesreceta.Add(new Product("Leche Entera", 820, 89, "1L"));
            ingredientesreceta.Add(new Product("Mantequilla", 850, 12, "125g"));
            ingredientesreceta.Add(new Product("Pimienta", 430, 84, "15g"));
            ingredientesreceta.Add(new Product("Vino Sauvignon Blanc Reserva Botella", 4150, 23, "750cc"));
            ingredientesreceta.Add(new Product("Sal Lobos", 330, 150, "1kg"));
            ingredientesreceta.Add(new Product("Láminas de Lasaña", 1250, 85, "400g"));
            ingredientesreceta.Add(new Product("Harina", 890, 43, "1kg"));
            ingredientesreceta.Add(new Product("Carne Molida", 4390, 15, "500g"));
            ingredientesreceta.Add(new Product("Aceite de Oliva", 1790, 77, "250g"));
            ingredientesreceta.Add(new Product("Malla de Cebollas", 1090, 91, "1kg"));
            ingredientesreceta.Add(new Product("Tomates Pelados en lata", 700, 48, "540g"));
            ingredientesreceta.Add(new Product("Queso Parmesano", 3790, 41, "200g"));
            ingredientesreceta.Add(new Product("Bolsa de Zanahorias", 890, 74, "1un"));
